  ...
  return (
    ...
    { toggle   ? 
     <form className="login-form" onSubmit={login}>
      ...
      {errorMessage  ? <p className="error" onClick={() => setErrorMessage("")}>{errorMessage}</p> : null}
     <label>Login</label>  
     <MyInput
    ...
    <MyInput
      ...
      onChange={(e) => setRegister({ ...register, nickname: e.target.value })}
    />
    <label>Login</label>  
    <MyInput
      value={register.login}
    ...
    <MyInput
      ...
      onChange={(e) => setRegister({ ...register, confirmedPassword: e.target.value })}
    />
    <button disabled={Object.values(register).some((val) => val === "") || register.password !== register.confirmedPassword}>Create account</button>
